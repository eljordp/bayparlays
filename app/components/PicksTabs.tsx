...
// Sub-navigation for the "Picks" section of the app. Shared across
// /parlays, /odds, /builder, /props so all four feel like one feature
// with four views, not four separate pages in the top nav.
//
// Rendered just under AppNav on each of those pages.
