        ...
        <div className="w-full max-w-[720px] mx-auto">
          ...
          >
            ...
            <div className="space-y-6 text-base text-white/50 leading-relaxed">
              <p>
                AI-powered parlay optimization. We scan 12+ sportsbooks, find
                where the odds disagree, and build parlays where the math is in
                your favor.
              </p>

              <p>
                Built by bettors, for bettors. No guru picks. No hunches. Just
                data.
              </p>
              ...
              <p className="text-white/30 text-sm" style={{ fontFamily: "var(--font-geist-mono)" }}>
                ...
                <a
                  ...
                  className="text-[#FF3B3B]/70 hover:text-[#FF3B3B] transition-colors"
                >
                  eljordp@gmail.com
                </a>
              </p>
